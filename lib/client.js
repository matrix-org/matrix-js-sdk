...
/**
* Invite another user to presence list.
* @param {module:client.callback} callback Optional.
* @param {string} userId
* @return {module:client.Promise} Resolves: TODO
* @return {module:http-api.MatrixError} Rejects: with an error response.
*/
MatrixClient.prototype.inviteToPresenceList = function(callback, userId) {
  let opts = {"invite" : [userId]};
  return _presenceList(callback, this, opts, "POST");
}

/**
* Drop user from presence list.
* @param {module:client.callback} callback Optional.
* @param {string} userId
* @return {module:client.Promise} Resolves: TODO
* @return {module:http-api.MatrixError} Rejects: with an error response.
**/
MatrixClient.prototype.dropFromPresenceList = function(callback, userId) {
  let opts = {"drop" : [userId]};
  return _presenceList(callback, this, opts, "POST");
}
/**
