 ...
 * @return {module:http-api.MatrixError} Rejects: with an error response.
 */
MatrixClient.prototype._setMembershipState = function(roomId, userId,
                                                      membershipValue, reason, 
                                                      callback) {
 ...
 * @return {module:http-api.MatrixError} Rejects: with an error response.
 */
MatrixClient.prototype._membershipChange = function(roomId, userId, membership, reason, 
                            callback) {
    if (utils.isFunction(reason)) { callback = reason; reason = undefined; }
 ...
 * @param {module:client.callback} callback Optional.
 */
MatrixClient.prototype._pollForEvents = function(callback) {
    var self = this;
    if (!this.clientRunning) {
        return;
    }
