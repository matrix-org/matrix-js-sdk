...
function OlmDevice(sessionStore) {
    ...
    // This partially mitigates a replay attack where a MITM resends a group message into the room.
    // TODO: If we ever remove an event from memory we will also need to remove it from this map.
