...
class InteractiveAuth {
  ...
  constructor(opts) {
    ...
    this.emailSid = (_opts$emailSid = opts.emailSid) !== null && _opts$emailSid !== void 0 ? _opts$emailSid : null;
  }
  /**
  ...
  attemptAuth() {
    ...
    if (!((_this$data = this.data) !== null && _this$data !== void 0 && _this$data.flows)) {
      ...
      (_this$busyChangedCall = this.busyChangedCallback) === null || _this$busyChangedCall === void 0 ? void 0 : _this$busyChangedCall.call(this, true); // use the existing sessionId, if one is present.
  ...
  async doRequest(auth, background = false) {
    try {
      ...
      var _error$data$flows, _error$data;

      // sometimes UI auth errors don't come with flows
      const errorFlows = (_error$data$flows = (_error$data = error.data) === null || _error$data === void 0 ? void 0 : _error$data.flows) !== null && _error$data$flows !== void 0 ? _error$data$flows : null;
