...
class MatrixEvent extends _events.EventEmitter {
  ...
  get threadRootId() {
    ...
    if ((relatesTo === null || relatesTo === void 0 ? void 0 : relatesTo.rel_type) === _event.RelationType.Thread) {
  ...
  get parentEventId() {
    var _relations$mIn_reply;

    const relations = this.getWireContent()["m.relates_to"];
    return (relations === null || relations === void 0 ? void 0 : (_relations$mIn_reply = relations["m.in_reply_to"]) === null || _relations$mIn_reply === void 0 ? void 0 : _relations$mIn_reply["event_id"]) || (relations === null || relations === void 0 ? void 0 : relations.event_id);
  }

  get replyEventId() {
    var _relations$mIn_reply2;

    const relations = this.getWireContent()["m.relates_to"];
    return relations === null || relations === void 0 ? void 0 : (_relations$mIn_reply2 = relations["m.in_reply_to"]) === null || _relations$mIn_reply2 === void 0 ? void 0 : _relations$mIn_reply2["event_id"];
  }
  /**
