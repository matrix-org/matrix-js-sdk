 ...
 */
Room.prototype.addFilteredTimelineList(filter) {
 ...
 */
Room.prototype.removeFilteredTimelineList(filter) {
...
Room.prototype._handleRemoteEcho = function(remoteEvent, localEvent) {
    ...
    for (var i = 0; i < this._timelineLists.length; i++) {
        ...
        var existingTimeline = timelineList._eventIdToTimeline[oldEventId];
        if (existingTimeline) {
