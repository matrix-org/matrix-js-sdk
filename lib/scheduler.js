...
class MatrixScheduler {
  ...
  constructor(retryAlgorithm = MatrixScheduler.RETRY_BACKOFF_RATELIMIT, queueAlgorithm = MatrixScheduler.QUEUE_MESSAGES) {
    ...
    (0, _defineProperty2.default)(this, "queues", {});
    (0, _defineProperty2.default)(this, "activeQueues", []);
    (0, _defineProperty2.default)(this, "procFn", null);
    (0, _defineProperty2.default)(this, "processQueue", queueName => {
      // get head of queue
