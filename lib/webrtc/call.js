...
/**
 * Place a screen-sharing call to this room. Only the screen will be shared;
 * no audio or video from a camera.
 * @param {Element} remoteVideoElement a <code>&lt;video&gt;</code> DOM element
 * to render video to.
 * @param {Element} localVideoElement a <code>&lt;video&gt;</code> DOM element
 * to render the local camera preview.
...
MatrixCall.prototype.placeScreenSharingCall = function(remoteVideoElement, localVideoElement) {
    ...
    this.localVideoElement = localVideoElement;
    this.remoteVideoElement = remoteVideoElement;
    var constraints = _getChromeScreenSharingConstraints(this);
    if (!constraints) {
        return;
    }
    _placeCallWithConstraints(this, constraints);
    this.type = 'video';
    _tryPlayRemoteStream(this);
};
 ...
 * @private
 */
MatrixCall.prototype._getUserMediaFailed = function(e) {
    this.emit(
        "error",
        callError(
