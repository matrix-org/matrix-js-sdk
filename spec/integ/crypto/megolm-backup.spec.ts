...
describe.each(Object.entries(CRYPTO_BACKENDS))("megolm-keys backup (%s)", (backend: string, initCrypto: InitCrypto) => {
    ...
    //         /// =====
    //
    //         const awaitHasQueriedOldBackup: IDeferred<void> = defer<void>();
    ...
    //         );
    //
    //         const backupVersion2 = { version: "2", ...testData.SIGNED_BACKUP_DATA };
    //         fetchMock.get("path:/_matrix/client/v3/room_keys/version", backupVersion2, { overwriteRoutes: true });
    //
    //         console.log(`Updated backup ${JSON.stringify(backupVersion2)}`);
    ...
    //         await syncPromise(aliceClient);
    //
    //         await awaitHasQueriedOldBackup.promise;
    //
