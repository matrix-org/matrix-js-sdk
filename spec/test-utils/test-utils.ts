 ...
 * @return Resolves once the client has emitted a SYNCING event
 */
 ...
 * @return An instantiated object with spied methods/properties.
 */
 ...
 * @return a JSON object representing this event.
 */
