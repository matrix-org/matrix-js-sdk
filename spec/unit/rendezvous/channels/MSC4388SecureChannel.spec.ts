...
import {
    MSC4388RendezvousSession as RendezvousSession,
    MSC4388SecureChannel as SecureChannel,
    PayloadType,
} from "../../../../src/rendezvous";

describe("MSC4388SecureChannel", () => {
    ...
    it("should generate qr code data as expected", async () => {
        ...
        const channel = new SecureChannel(session, QrCodeIntent.Login);
    ...
    it("should throw error if attempt to connect multiple times", async () => {
        const mockSession = {
            ...
            id,
            baseUrl,
        } as unknown as RendezvousSession;
        const channel = new SecureChannel(mockSession, QrCodeIntent.Reciprocate);
    ...
    describe("should be able to connect as a reciprocating device", () => {
        let mockSession: RendezvousSession;
        ...
        beforeEach(async () => {
            ...
            channel = new SecureChannel(mockSession, QrCodeIntent.Reciprocate);
