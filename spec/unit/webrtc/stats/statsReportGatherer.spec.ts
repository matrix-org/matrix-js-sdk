    ...
    describe("on process stats", () => {
        it("if active calculate stats reports", async () => {
            ...
            expect(actual).toEqual({
                ...
                audioTrackSummary: { count: 0, muted: 0, maxJitter: 0, maxPacketLoss: 0,concealedAudio: 0, totalAudio:0 },
                videoTrackSummary: { count: 0, muted: 0, maxJitter: 0, maxPacketLoss: 0,concealedAudio: 0, totalAudio:0 },
            });
