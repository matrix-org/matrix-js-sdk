            ...
            const summary = [
                {
                    ...
                    audioTrackSummary: { count: 1, muted: 1, maxJitter: 0, maxPacketLoss: 0, concealedAudioRatio: 0 },
                    videoTrackSummary: { count: 1, muted: 0, maxJitter: 0, maxPacketLoss: 0 },
                },
            ];
            reporter.build(summary);
        ...
        it("should find max jitter and max packet loss", async () => {
            const summary = [
                ...
                },
                {
                    ...
                    receivedAudioMedia: 1,
                    receivedVideoMedia: 1,
                    audioTrackSummary: { count: 1, muted: 0, maxJitter: 20, maxPacketLoss: 5, concealedAudioRatio: 0 },
                    videoTrackSummary: { count: 1, muted: 0, maxJitter: 0, maxPacketLoss: 0 },
                },
                {
                    receivedMedia: 1,
                    receivedAudioMedia: 1,
                    receivedVideoMedia: 1,
                    audioTrackSummary: { count: 1, muted: 0, maxJitter: 2, maxPacketLoss: 5, concealedAudioRatio: 0 },
