...
export class CrossSigningInfo {
     ...
     *     key
     *
     * @deprecated Use `isCrossSigningStoredInSecretStorage`.
     */
    public async isStoredInSecretStorage(
        secretStorage: ServerSideSecretStorage,
    ): Promise<Record<string, object> | null> {
        return isCrossSigningStoredInSecretStorage(secretStorage);
    }
 ...
 *     key
 */
export async function isCrossSigningStoredInSecretStorage(
    secretStorage: ServerSideSecretStorage,
): Promise<Record<string, object> | null> {
