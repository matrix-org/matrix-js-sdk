...
export class OlmDevice {
     ...
     */
    async addInboundGroupSession(roomId, senderKey, forwardingCurve25519KeyChain, sessionId, sessionKey, keysClaimed, exportFormat) {
    ...
    async addInboundGroupSessionWithheld(roomId, senderKey, sessionId, code, reason) {
        await this._cryptoStore.doTxn('readwrite', [IndexedDBCryptoStore.STORE_INBOUND_GROUP_SESSIONS_WITHHELD], (txn) => {
