    ...
    async _decryptMessage(theirDeviceIdentityKey, message) {
        ...
        for (let i = 0; i < sessionIds.length; i++) {
            ...
            try {
                ...
                logger.log("Decrypted Olm message from " + theirDeviceIdentityKey +
        ...
        if (message.type !== 0) {
            ...
            throw new Error("Error decrypting non-prekey message with existing sessions: " +
        ...
        try {
            ...
            throw new Error("Error decrypting prekey message: " +
                JSON.stringify(decryptionErrors));
        }
        logger.log("created new inbound Olm session ID " +
