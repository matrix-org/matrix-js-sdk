...
import { type MSC4388SecureChannel } from "./channels/MSC4388SecureChannel.ts";
 ...
 * @experimental Note that this is UNSTABLE and may have breaking changes without notice.
 */
export class MSC4108v2025SignInWithQR implements MSC4108SignInWithQR {
    ...
    public setFailureListener(listener?: RendezvousFailureListener): void {
