...
import { RoomState, RoomStateEvents } from "../models/room-state";
...
export class MemoryStore implements IStore {
    ...
    public storeRoom(room: Room) {
        ...
        // map up-to-date.
        room.currentState.on(RoomStateEvents.Members, this.onRoomMember);
    ...
    public removeRoom(roomId: string): void {
        if (this.rooms[roomId]) {
            this.rooms[roomId].currentState.removeListener(RoomStateEvents.Members, this.onRoomMember);
        }
